...
export default function ReaderToolbar(p: Props) {
  return <header className="reader-toolbar">
    ...
    <div className="reader-actions" role="toolbar" aria-label="Reader controls">
      ...
      <button className="toolbar-button history-control" onClick={p.onBack} disabled={!p.canGoBack} title="Back to previous location">↶<span className="sr-only">Back</span></button>
      <button className="toolbar-button history-control" onClick={p.onForward} disabled={!p.canGoForward} title="Forward to next location">↷<span className="sr-only">Forward</span></button>
      ...
      <button className="toolbar-button" onClick={p.onCopyLocation} disabled={!p.hasBook} title="Copy location">Copy location</button>
